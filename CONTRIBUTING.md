...
2. Open issue using one of the templates.
3. Be as detailed as possible - include the package version, what you did, what you expected to happen, and what actually happened.
